                    ...
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-12 mb-2">
                                <label
                                    class="form-label">{{ $lang->data['payment_mode'] ?? 'Payment Method' }}</label>
                                <select class="form-select" wire:model="payment_mode">
                                    <option value="">{{ $lang->data['choose_payment_mode'] ?? 'Choose Payment Method' }}
                                    </option>
                                    <option class="select-box" value="1">{{ $lang->data['cash'] ?? 'Cash' }}
                                    </option>
                                    <option class="select-box" value="2">{{ $lang->data['gcash'] ?? 'Gcash' }}</option>
