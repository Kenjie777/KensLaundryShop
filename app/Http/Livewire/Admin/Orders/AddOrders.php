...
{
    public $services,$search_query,$order_id,$inputs = [],$selservices = [],$customer,$date,$delivery_date,$paid_amount,$payment_type;
    ...
    public function calculateTotal()
    {
        ...
        $this->total = $this->sub_total + $this->addon_total;
    ...
    public function save()
    {
        ...
        if($this->flag == 0)
        {
            $order = Order::create([
                ...
                'financial_year_id' => !empty(getFinancialYearId()) ? getFinancialYearId() : null
            ]);
